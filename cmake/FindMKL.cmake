#
# Taken from https://repository.prace-ri.eu/git/CodeVault/hpc-kernels/structured_grids/-/blob/master/cmake/Modules/FindMKL.cmake
...
if (NOT MKLROOT_PATH)
	...
	if (EXISTS $ENV{MATHROOT})
	  set(MKLROOT_PATH $ENV{MATHROOT})
         endif()
...
#        find_library(LIB_IMF NAMES imf HINTS ${MKL_LIBRARY_DIR} ${EXPECT_MKL_LIBPATH})
